...
namespace Gimnasio.GimnasioDataSet1TableAdapters {
...
SELECT cliente_id, nombre, apellido, dni, fecha_nac, sexo, borrado_logico FROM Cliente WHERE (cliente_id = @cliente_id)";
        ...
        public virtual int Fill(GimnasioDataSet1.ClienteDataTable dataTable) {
        ...
        public virtual GimnasioDataSet1.ClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GimnasioDataSet1.ClienteDataTable dataTable = new GimnasioDataSet1.ClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GimnasioDataSet1.ClienteDataTable dataTable) {
